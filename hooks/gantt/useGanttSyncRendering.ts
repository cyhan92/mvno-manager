...
interface UseGanttSyncRenderingProps {
  displayTasks: Task[]
...
export const useGanttSyncRendering = ({
  displayTasks,
  expandedNodes,
  renderChart,
  canvasRef,
  triggerRender
}: UseGanttSyncRenderingProps) => {
  ...
  }, [displayTasks.length, expandedNodes, renderChart, canvasRef, triggerRender])
}
